...
export const MSG = {
  ...
  // Universal Blocker
  GET_BLOCK_STATUS: 'GET_BLOCK_STATUS', // { url } → { blocked, matchedRule }
  TEMP_ALLOW_URL: 'TEMP_ALLOW_URL',     // { url, durationMs } → adds temporary exception
  BLOCKED_URLS_UPDATED: 'BLOCKED_URLS_UPDATED', // Broadcast to content scripts
};
...
export const DEFAULT_SETTINGS = {
  ...
  breakMaxPerDayCount: 5,      // Max number of breaks allowed per day
...
export const STORAGE_KEYS = {
  ...
  BLOCKED_URLS: 'fg_blocked_urls',        // Array of { id, name, pattern, normalizedPattern, type, enabled, createdAt, updatedAt, version }
};
